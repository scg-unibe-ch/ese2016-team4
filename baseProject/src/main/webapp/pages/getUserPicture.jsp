<%@page import="ch.unibe.ese.team4.model.Picture"%>
<%@page import="ch.unibe.ese.team4.model.User"%>
<%@page import="java.util.Iterator"%>
<%@page import="ch.unibe.ese.team4.model.Location"%>
<%@page import="java.util.List"%>
<%@page import="ch.unibe.ese.team4.controller.service.UserService"%>
